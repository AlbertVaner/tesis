...
for folder in (
    ROOT / "controllers" / "two_drones",
    ROOT / "controllers" / "single_drone" / "buttons",
    ROOT / "controllers" / "single_drone" / "camera",
    ROOT / "controllers" / "single_drone" / "flowdeck",
    ROOT / "controllers" / "shared",
    LEGACY / "drone_control",
    LEGACY / "Integration",
    ROOT / "external" / "gesture_detection",
):
