...
def build():
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\diagnostico_flowdeck_dos_drones.py", "Comprobar ambos drones, uno después del otro, sin motores")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\diagnostico_flowdeck_dos_drones.py --tiempo 10", "Ampliar el muestreo a 10 segundos por dron")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\diagnostico_flowdeck_dos_drones.py --radio1 2B1D933FCC --radio2 9DD2507072", "Elegir las antenas manualmente")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\hover_flowdeck_dron1.py")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\hover_flowdeck_dron1.py --altura 0.45 --tiempo 10", "Definir altura y duración")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\hover_flowdeck_dron1.py --radio 9DD2507072", "Seleccionar una Crazyradio")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\panel_control_flowdeck_dron1.py")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_camara_flowdeck_dron1.py")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_camara_flowdeck_dron1.py --camera 1", "Usar la cámara secundaria")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\panel_control_flowdeck_dos_drones.py")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_camara_flowdeck_dos_drones.py --target hands", "Mano izquierda=Dron 1; mano derecha=Dron 2")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_camara_flowdeck_dos_drones.py --target drone1", "Controlar solo el dron 1")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_camara_flowdeck_dos_drones.py --target drone2", "Controlar solo el dron 2")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_camara_flowdeck_dos_drones.py --target both", "Una mano controla ambos")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dron_individual_interfaz.py --drone 1", "Panel individual del dron 1")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dron_individual_interfaz.py --drone 2", "Panel individual del dron 2")
    doc.add_heading("7.2 Dos drones por botones", level=2)
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dos_drones_botones_lowlevel.py", "Control low-level con MoCap")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dos_drones_cruz_botones.py", "Control high-level por botones")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dos_drones_cruz_botones.py --dry-run", "Simulación sin radios ni motores")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dos_drones_cruz_botones.py --single drone2", "Habilitar solo el dron 2")
    ...
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dos_drones_cruz_camara_multiprocessing.py --target drone2", "Cámara para un único dron")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\control_dos_drones_cruz_camara_multiprocessing.py --dry-run", "Prueba de cámara sin activar hardware")

    doc.add_heading("8. Marker joystick con Robotat", level=1)
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_controll_with_marker\discover_marker_id.py --id 64 --show-all", "Encontrar el tópico del marker")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_controll_with_marker\marker_orientation_check.py --marker-topic mocap/all --marker-id 64", "Verificar orientación sin conectar el dron")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_controll_with_marker\control_with_marker.py --marker-topic mocap/all --marker-id 64", "Iniciar el control de vuelo")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_controll_with_marker\analyze_marker_session.py", "Regenerar gráficas de la sesión")

    doc.add_heading("9. Pruebas y análisis", level=1)
    add_command(doc, r".\.venv\Scripts\python.exe .\Gesture_control\main_hands.py", "Probar únicamente el reconocimiento de gestos")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\prueba_estabilidad_dos_drones_lowlevel.py", "Prueba de estabilidad de dos drones con Robotat")
    add_command(doc, r".\.venv\Scripts\python.exe .\drone_control\analizar_sesion_dos_drones.py", "Analizar el CSV más reciente")
