...
Si la cámara no abre, prueba con índice 1 editando el archivo o usando `cv2.VideoCapture(1)`.

## Cómo correr el detector
...
El archivo `data/gestos_detectados.csv` guarda un registro de cada frame con:
...
Usa una ruta simple como `C:\Tesis\vision_campu` para evitar problemas con espacios y caracteres especiales.
