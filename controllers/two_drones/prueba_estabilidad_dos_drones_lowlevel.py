...
Ejemplo recomendado para la primera prueba:
    .\.venv\Scripts\python.exe .\controllers\two_drones\prueba_estabilidad_dos_drones_lowlevel.py

Q corta los motores de ambos drones inmediatamente. Al finalizar, se genera un
CSV en results/data/dos_drones y se ejecuta su analizador de graficas.
"""
