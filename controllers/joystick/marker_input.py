...
from control_with_marker import (angle_delta_deg,tilt_to_speed,PITCH_TO_X_SIGN,ROLL_TO_Y_SIGN,VERTICAL_DEADZONE_M,LAND_MARKER_BELOW_M,LAND_HOLD_S)
...
class MarkerInput:
    ...
    def calibrate(self):
        ...
        if pose is None: raise ValueError('No hay una pose reciente del marker seleccionado')
